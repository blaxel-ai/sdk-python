...
from llama_index.core.base.llms.generic_utils import (
    ...
    chat_to_completion_decorator, get_from_param_or_env,
...
from mistralai.models import (AssistantMessage, ContentChunk, ImageURLChunk,
                              Messages, SystemMessage, TextChunk, ToolCall,
...
def mistralai_modelname_to_contextsize(modelname: str) -> int:
    ...
    for model in MISTRALAI_MODELS:
        if modelname.startswith(model):
            return MISTRALAI_MODELS[model]
