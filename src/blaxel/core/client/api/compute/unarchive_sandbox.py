...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/sandboxes/{sandbox_name}/unarchive",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Unarchive sandbox
     ...
     Recreates an archived sandbox from its archive. The recreated sandbox runs the current generation
    whatever generation it was archived from, restores the archived filesystem before anything starts,
    and starts the saved processes again with new process identifiers.
