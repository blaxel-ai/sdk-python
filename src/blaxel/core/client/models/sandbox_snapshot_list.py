...
T = TypeVar("T", bound="SandboxSnapshotList")


@_attrs_define
class SandboxSnapshotList:
    """Cursor-paginated list of snapshots. Returned starting with API version 2026-04-28; older API versions return a bare
    array.

        Attributes:
            data (Union[Unset, list['SandboxSnapshot']]): Page of snapshots.
    ...
    data: Union[Unset, list["SandboxSnapshot"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any] | list[Any]) -> T | None:
        ...
        for data_item_data in _data or []:
            data_item = SandboxSnapshot.from_dict(data_item_data)
        ...
        sandbox_snapshot_list = cls(
            data=data,
            meta=meta,
        )

        sandbox_snapshot_list.additional_properties = additional_properties
        return sandbox_snapshot_list
