...
T = TypeVar("T", bound="AppRevisionConfiguration")


@_attrs_define
class AppRevisionConfiguration:
    ...
    Attributes:
        ...
        canary_percent (Union[Unset, int]): Canary revision percent (0-100) Example: 10.
        sticky_session_ttl (Union[Unset, int]): Sticky session TTL in seconds (0 = disabled)
        traffic (Union[Unset, int]): Traffic percentage for deployment Example: 100.
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T | None:
        ...
        app_revision_configuration = cls(
            active=active,
            canary=canary,
        ...
        app_revision_configuration.additional_properties = d
        return app_revision_configuration
