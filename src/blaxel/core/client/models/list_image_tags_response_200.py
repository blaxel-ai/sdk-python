...
T = TypeVar("T", bound="ListImageTagsResponse200")


@_attrs_define
class ListImageTagsResponse200:
    """
    Attributes:
        data (list['ImageTag']):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T | None:
        ...
        for data_item_data in _data:
            data_item = ImageTag.from_dict(data_item_data)
        ...
        list_image_tags_response_200.additional_properties = d
        return list_image_tags_response_200
